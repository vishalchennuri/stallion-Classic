  ...
  const eligibilityRules = [
    {
      ...
      description:
        "Participants must be 18 years or older. Valid ID required for verification.",
    },
    {
      icon: <Trophy className="h-5 w-5 sm:h-6 sm:w-6 text-[#dc4a26]" />,
      title: "Competition Categories",
      description:
        "Athletes must compete in their designated category based on experience level and weight class.",
    },
    {
      icon: <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-[#dc4a26]" />,
      title: "Health Certification",
      description:
        "Medical clearance certificate from a licensed physician required within 30 days of competition.",
    },
    {
      icon: <Calendar className="h-5 w-5 sm:h-6 sm:w-6 text-[#dc4a26]" />,
      title: "Registration Deadline",
      description:
        "All registrations must be completed 7 days prior to the event date.",
    },
  ];
    ...
    <section className="py-12 sm:py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <AnimatedSection className="text-center mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl text-black mb-2 sm:mb-3 font-[impact]">
            RULES & REGULATIONS
          </h2>
          <p className="text-xl sm:text-2xl text-gray-800 font-[CreatoDisplay]">
        ...
        <AnimatedSection className="mb-12 sm:mb-16">
          <div className="max-w-6xl mx-auto">
            <h3 className="text-2xl sm:text-3xl md:text-4xl text-black mb-6 sm:mb-8 font-[impact] text-center">
              ELIGIBILITY REQUIREMENTS
            </h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 font-[CreatoDisplay]">
              {competitionRules.map((section, index) => (
                ...
                >
                  <div className="border border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-lg transition-shadow duration-300">
                    <h4 className="text-xl sm:text-2xl font-medium text-gray-800 mb-4 sm:mb-6">
                      {section.title}
                    </h4>
        ...
        <AnimatedSection className="mt-12 sm:mt-16" delay={0.6}>
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#dc4a26] text-white rounded-lg p-6 sm:p-8 text-center font-[CreatoDisplay]">
              ...
              <h4 className="text-xl sm:text-2xl font-medium mb-3 sm:mb-4">
                IMPORTANT NOTICE
              </h4>
              <p className="text-sm sm:text-base leading-relaxed">
                Violation of any rules or regulations may result in immediate
                disqualification without refund. All decisions made by judges
                and officials are final. Participants compete at their own risk
